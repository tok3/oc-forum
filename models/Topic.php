<?php namespace Eq3w\Forum\Models;
...
class Topic extends Model
{
     ...
     */
    public $table = 'eq3w_forum_topics';
     ...
     */
    public $hasOne = [
        'first_post' => ['Eq3w\Forum\Models\Post', 'order' => 'created_at asc']
    ];

    public $belongsTo = [
        'channel'          => ['Eq3w\Forum\Models\Channel'],
        'start_member'     => ['Eq3w\Forum\Models\Member'],
        'last_post'        => ['Eq3w\Forum\Models\Post'],
        'last_post_member' => ['Eq3w\Forum\Models\Member'],
    ];

    public $belongsToMany = [
        'followers' => ['Eq3w\Forum\Models\Member', 'table' => 'eq3w_forum_topic_followers', 'timestamps' => true]
    ];
    ...
    public static function checkThrottle($member)
    {
        ...
        $throttleCount = Config::get('eq3w.forum::throttleCount', 2);
        $throttleMinutes = Config::get('eq3w.forum::throttleMinutes', 15);
