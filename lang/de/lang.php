...
return [
    'topics' => [
        'component_name' => 'Themen Liste',
        'component_description' => 'Liste aller Themen anzeigen.',
        'per_page' => 'Themen pro Seite',
        'per_page_validation' => 'Üngülgiges Format des "Themen pro Seiote" - Wertes'
    ],
    'topic' => [
        'page_name' => 'Themen Seite',
        'page_help' => 'Seitenname, der für das Klicken auf ein Gesprächsthema verwendet werden soll.'
    ],
    'posts' => [
        'component_name' => 'Posts Liste',
        'component_description' => 'Liste aller Posts anzeigen.',
        'per_page' => 'Posts pro Seite',
        'per_page_validation' => 'Posts pro Seite muss eine Zahl sein'
    ],
    'member' => [
        'page_name' => 'Member Page',
        'page_help' => 'Seitenname, der für das Klicken auf ein Mitglied verwendet werden soll.'
    ],
    'channel' => [
