...
class Topics extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'eq3w.forum::lang.topics.component_name',
            'description' => 'eq3w.forum::lang.topics.component_description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'topicsPerPage' =>  [
                'title'             => 'eq3w.forum::lang.topics.per_page',
                'type'              => 'string',
                'validationPattern' => '^[0-9]+$',
                'validationMessage' => 'eq3w.forum::lang.topics.per_page_validation',
                'default'           => '20',
            ]
        ];
    }
