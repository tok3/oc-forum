...
class EmbedTopic extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'eq3w.forum::lang.embedtopic.topic_name',
            'description' => 'eq3w.forum::lang.embedtopic.topic_self_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'embedCode' => [
                'title'       => 'eq3w.forum::lang.embedtopic.embed_title',
                'description' => 'eq3w.forum::lang.embedtopic.embed_desc',
                'type'        => 'string',
            ],
            'channelSlug' => [
                'title'       => 'eq3w.forum::lang.embedtopic.target_name',
                'description' => 'eq3w.forum::lang.embedtopic.target_desc',
                'type'        => 'dropdown'
            ],
            'memberPage' => [
