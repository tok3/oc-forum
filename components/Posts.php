...
class Posts extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'eq3w.forum::lang.posts.component_name',
            'description' => 'eq3w.forum::lang.posts.component_description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'postsPerPage' =>  [
                'title'             => 'eq3w.forum::lang.posts.per_page',
                'type'              => 'string',
                'validationPattern' => '^[0-9]+$',
                'validationMessage' => 'eq3w.forum::lang.posts.per_page_validation',
                'default'           => '20',
            ]
        ];
    }
