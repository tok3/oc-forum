...
class EmbedChannel extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'eq3w.forum::lang.embedch.channel_name',
            'description' => 'eq3w.forum::lang.embedch.channel_self_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'embedCode' => [
                'title'       => 'eq3w.forum::lang.embedch.embed_title',
                'description' => 'eq3w.forum::lang.embedch.embed_desc',
                'type'        => 'string',
                'group'       => 'Parameters',
            ],
            'channelSlug' => [
                'title'       => 'eq3w.forum::lang.embedch.channel_title',
                'description' => 'eq3w.forum::lang.embedch.channel_desc',
                'type'        => 'dropdown'
            ],
            'topicSlug' => [
                'title'       => 'eq3w.forum::lang.embedch.topic_name',
                'description' => 'eq3w.forum::lang.embedch.topic_desc',
                'type'        => 'string',
                'default'     => '{{ :topicSlug }}',
                'group'       => 'Parameters',
            ],
    ...
    public function init()
    {
        ...
        if (input('channel') || $this->property('topicSlug')) {
            ...
            $component = $this->addComponent('Eq3w\Forum\Components\Topic', $this->alias, $properties);
        }
        /*
         * Proxy as channel
         */
            ...
            $component = $this->addComponent('Eq3w\Forum\Components\Channel', $this->alias, $properties);
