...
class Channel extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'eq3w.forum::lang.channel.component_name',
            'description' => 'eq3w.forum::lang.channel.component_description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug' => [
                'title'       => 'eq3w.forum::lang.slug.name',
                'description' => 'eq3w.forum::lang.slug.desc',
                'default'     => '{{ :slug }}',
                'type'        => 'string',
            ],
            'memberPage' => [
